	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="col-md-12">
            ...
            <?php
                  ...
                  $usname=$_POST["uusrname"];
                  $email=$_POST["uemail"];
                  $pass=$_POST["upass"];
                  $name=$_POST["uname"];
                  $stID=$_POST["ustuID"];
                  $conn=$_POST["ucontact"];
                  $medisue=$_POST["umedical"];
                  $add=$_POST["uadd"];
                  $kel=$_POST["ukelo"];
                  $usrID=$_POST["upartID"];
                  $nn=$_POST["ntoupdate"];
                  $update2="UPDATE participants SET username='$usname', email='$email', password='$pass', name='$name', studentID='$stID', contact='$conn', medical_issues=null,  address='$add',
                  kelompok='$kel', participantID='$usrID' WHERE participantID=$nn";
                  $query=mysqli_query($con,$update2);
